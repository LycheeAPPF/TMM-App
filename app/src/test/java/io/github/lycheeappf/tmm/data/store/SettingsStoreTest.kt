 ...
 * reservierte Mapping-Id (statische Grok-Identität id 0) darf NIE dynamisch
 * vergeben werden, sonst bekäme ein Messenger-Mapping eine reservierte
 * Fake-Adresse. DataStore braucht einen echten Context → Robolectric.
 */
...
class SettingsStoreTest {
    ...
    fun `nextMappingId never returns a reserved id and stays strictly increasing`() = runTest {
        ...
        // Auf frischem Store beginnt die Vergabe direkt nach der reservierten {0}.
