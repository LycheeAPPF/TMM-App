...
object AssistantIdentity {
     ...
     * NIE dynamisch vergeben darf: aktuell nur die statische Grok-Id (0). Verhindert,
     * dass ein dynamisches Messenger-Mapping je die reservierte Fake-Adresse bekommt.
     */
    val RESERVED_MAPPING_IDS: Set<Long> = setOf(RESERVED_MAPPING_ID)
}
